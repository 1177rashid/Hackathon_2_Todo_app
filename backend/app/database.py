...
def init_db():
    ...
    IMPORTANT: This only creates the Task table.
    The User table is managed by Better Auth and should NOT be created here.
    """
    from app.models import Task

    # Only create Task table - User table is managed by Better Auth
